...
void MainWindow::createMenu()
{
    ...
    TMember equationsSystemsItems[equationsSystemsItemsCount] =
    {
        ...
        {"Метод оптимальных исключений", new EquationsSystemsFrame(this, ModeEqSysGaussOptimal)},
        {"Метод Гаусса-Жордана",         new EquationsSystemsFrame(this, ModeEqSysGaussJordan)},
